...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_with_ingreients(self):
    ...
    def test_partial_update_rescipe(self):
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        """Test returning recipes with recipe tags"""
        ...
        recipe3 = sample_recipe(user=self.user, title='Dessert')
    ...
    def test_filter_recipes_by_ingredients(self):
        """Test returning recipes with recipe ingredients"""
        recipe1 = sample_recipe(user=self.user, title='Curry')
        recipe2 = sample_recipe(user=self.user, title='Soup')
